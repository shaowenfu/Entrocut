...
app = FastAPI(title="EntroCut Core Skeleton", version=APP_VERSION)
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "http://127.0.0.1:5173",
...
def health() -> dict[str, Any]:
    return {
        ...
        "notes": [
            ...
            "This service is kept as a minimal FastAPI scaffold for the rewrite.",
        ],
    }
...
def root() -> dict[str, Any]:
    return {
        "service": "core",
        "phase": REWRITE_PHASE,
        "message": "EntroCut core is now a clean-room skeleton. Rebuild workflows on top of this surface.",
        "env": {
