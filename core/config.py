...
SERVER_DEFAULT_PROVIDER = os.getenv("SERVER_DEFAULT_PROVIDER", "google_gemini").strip() or "google_gemini"
SERVER_DEFAULT_MODEL = os.getenv("SERVER_DEFAULT_MODEL", "gemini-3.1-flash-lite-preview").strip() or "gemini-3.1-flash-lite-preview"
