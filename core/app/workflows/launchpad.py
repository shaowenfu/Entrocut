...
class LaunchpadWorkflowShell:
    ...
    async def notify_project_initialized(self, *, project_id: str, title: str, request_id: str | None = None) -> int:
    ...
    async def notify_media_completed(self, *, project_id: str, message: str, request_id: str | None = None) -> int:
